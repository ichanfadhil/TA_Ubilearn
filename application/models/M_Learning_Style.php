...
//         $ev_nilai = $this->calc($exercise_visit,17,10,13,15);
//         $qt_nilai = $this->calc($ques_detail,10,5,6,8);
//         $qf_nilai = $this->calc($ques_facts,10,5,6,8);
//         $qc_nilai = $this->calc($ques_concepts,10,5,6,8);
//         $qd_nilai = $this->calc($ques_develop,10,5,6,8);
//         $qs_nilai = $this->calc($ques_stay_results,10,5,6,8);

//         $sum = $cv_nilai + $cs_nilai + $xv_nilai + $xs_nilai + $sv_nilai + $ss_nilai + $ev_nilai + $qt_nilai + $qf_nilai + $qc_nilai + $qd_nilai + $qs_nilai;
//         $hasil1 = $sum/12;
...
// 		$cv_nilai = $this->calc($content_visit,20,10,13,16);
//         $qg_nilai = $this->calc($ques_graph,10,5,6,8);
//         $qx_nilai = $this->calc($ques_text,10,5,6,8);
// 		$fv_nilai = $this->calc($forum_visit,15,5,6,8);
...
// 		$sum = $cv_nilai + $cs_nilai + $os_nilai + $xs_nilai + $sv_nilai + $ss_nilai+ $ev_nilai+ $es_nilai+ $fv_nilai+ $fp_nilai;
//         $hasil3 = $sum/10;
...
//         $os_nilai = $this->calc($outline_stay,17,10,13,15);
//         $qt_nilai = $this->calc($ques_detail,10,5,6,8);
//         $qo_nilai = $this->calc($ques_overview,10,5,6,8);
//         $qi_nilai = $this->calc($ques_interpret,10,5,6,8);
//         $qd_nilai = $this->calc($ques_develop,10,5,6,8);
//         $ns_nilai = $this->calc($nav_skip,10,5,6,8);
//         $no_nilai = $this->calc($nav_overview_visit,10,5,6,8);
