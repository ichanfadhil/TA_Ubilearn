            ...
            <div class="mdl-card__title" style="display: block">
              <div class="mdl-grid">
                <div class="mdl-cell mdl-cell--12-col">
                    ...
                    <p style="color: white">Aku bisa terbuat dengan berbagai syarat, syaratnya tiap node hanya boleh memiliki maksimal dua subtree dan  kedua subtree tersebut harus terpisah. Lalu apakah aku ini?</p>
                </div>
              </div>
            </div>
        </div>
            ...
            <div class="mdl-card__supporting-text" style="display: block">
              <div class="mdl-grid">
                ...
                <p>
                    ...
                    <label for="">Binary Search Tree</label>
                </p>
                <!-- //jawaban bener -->
                <p>
                    <input type="radio" name="jawaban1" id="jawaban1" value="">
                    <label for="">Binary Tree</label>
                </p>
                <p>
                    <input type="radio" name="jawaban1" id="jawaban1" value="">
                    <label for="">General Tree</label>
                </p>
                <p>
                    <input type="radio" name="jawaban1" id="jawaban1" value="">
                    <label for="">Subtree</label>
                </p>
                <hr style="color: white" />
