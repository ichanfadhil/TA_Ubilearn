            ...
            <div class="mdl-card__title" style="display: block">
              <div class="mdl-grid">
                <div class="mdl-cell mdl-cell--12-col">
                    ...
                    <p style="color: white">Apa pengertian dari binary tree?</p>
                </div>
              </div>
            </div>
        </div>
            ...
            <div class="mdl-card__supporting-text" style="display: block">
              <div class="mdl-grid">
                ...
                <p>
                    ...
                    <label for="">Tree yang tiap nodenya (kecuali leaf) memiliki dua child dan tiap subtree harus mempunyai panjang path yang sama.</label>
                </p>
                <!-- //jawaban bener -->
                <p>
                    <input type="radio" name="jawaban1" id="jawaban1" value="">
                    <label for="">Tree dengan syarat bahwa tiap node hanya boleh memiliki maksimal dua subtree dan kedua subtree tersebut harus terpisah.</label>
                </p>
                <p>
                    <input type="radio" name="jawaban1" id="jawaban1" value="">
                    <label for="">Tiap subtree boleh memiliki panjang path yang berbeda.</label>
                </p>
                <p>
                    <input type="radio" name="jawaban1" id="jawaban1" value="">
                    <label for="">Tree yang mempunyai semua nodenya (kecuali leaf) hanya memiliki satu child.</label>
                </p>
                <hr style="color: white" />
