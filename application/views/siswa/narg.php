            ...
            <div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--12-col-phone">
                ...
                <?php
                    ...
                    <ul class="mdl-list" style="margin: 15px;" >
                        ...
                        <i class="material-icons mdl-list__item-icon" style="font-size: 30px; color: white;">text_fields</i>
...
<div class="mdl-cell mdl-cell--8-col-desktop mdl-cell--3-col-tablet mdl-cell--8-col-phone">
    ...
    margin-left: 150px;"><i class="fa fa-angle-double-down" ></i></button>
                ...
                <span class="mdl-list__item-primary-content">
                    <a style="text-decoration:none;" href="<?php echo site_url('siswa/intuitive1'.$lsn_id) ?>" ><span style="color:white" style="margin-left:20px">Latihan Soal 1</span></a>
                </span>
                </li>
                <li class="mdl-list__item">
                <span class="mdl-list__item-primary-content">
                <a style="text-decoration:none;" href="<?php echo site_url('siswa/intuitive2'.$lsn_id) ?>" ><span style="color:white" style="margin-left:20px">Latihan Soal 2</span></a>
                </span>
                </li>
                <li class="mdl-list__item">
                <span class="mdl-list__item-primary-content">
                <a style="text-decoration:none;" href="<?php echo site_url('siswa/intuitive3'.$lsn_id) ?>" ><span style="color:white" style="margin-left:20px">Latihan Soal 3</span></a>
                </span>
                </li>
...
<div class="mdl-grid">
    <div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--12-col-phone">
        <div class="mdl-card mdl-shadow--2dp trending">
            ...
            <form method="post" action="<?php echo base_url().'siswa/Content/notes_narg/'.$lsn_id?>">
            <?php
