            ...
            <div class="mdl-card__title" style="display: block">
              <div class="mdl-grid">
                <div class="mdl-cell mdl-cell--12-col">
                    ...
                    <p style="color: white">Aku merupakan simpul. Aku terletak diatas suatu node yang sedang diperhatikan. Aku biasa disebut tua. Apakah aku?</p>
                </div>
              </div>
            </div>
        </div>
